...
public abstract class Tree {
     ...
     */
    public static final int IF = CATCH + 1;

    public static final int SCOPY = IF + 1;

    public static final int GUARDEDSTMT= SCOPY + 1;

    public static final int IFSUBSTMT = GUARDEDSTMT + 1;

    public static final int VAR = IFSUBSTMT + 1;

    public static final int ARRAYCONSTANT = VAR + 1;
     ...
     */
    public static final int EXEC = FOREACHSTMT + 1;
     ...
     */
    public static final int ASSIGN = NEWARRAY + 1;

    /**
     * Calculate expressions, of type Calculate.
     */
    public static final int CALCULATE = ASSIGN + 1;

    /**
     * Type cast expressions, of type TypeCast.
     */
    public static final int TYPECAST = CALCULATE + 1;
     ...
     */
    public static final int NULLCHK = COMPL + 1;
    ...
    public static class ForLoop extends Tree {
        ...
        public ForLoop(Tree init, Expr condition, Tree update, Tree loopBody,
                       Location loc) {
            super(FORLOOP, loc);
            this.init = init;
            this.condition = condition;
    ...
    public static class GuardedStmt extends Tree {
        ...
        public GuardedStmt(List<Tree> branch, Location loc) {
    ...
    public static class ArrayConstant extends Expr {
        public List<Expr> constantList;

        public ArrayConstant(List<Expr> constantList, Location loc) {
    ...
    public static class ArrayRepeat extends Expr {
        public Expr expr, intconst;

        public ArrayRepeat(Expr expr, Expr intconst, Location loc) {
            super(ARRAYCONSTANT, loc);
            this.expr = expr;
    ...
    public static class ArrayConcat extends Expr {
        ...
        public ArrayConcat(Expr expr, Expr expr2, Location loc) {
            super(ARRAYCONSTANT, loc);
            this.expr = expr;
            this.expr2 = expr2;
        }
    ...
    public static class SubArray extends Expr {
        public Expr expr, start, end;

        public SubArray(Expr expr, Expr start, Expr end, Location loc) {
            super(SUBARRAY, loc);
            this.expr = expr;
            this.start = start;
            this.end = end;
    ...
    public static class ArrayDefault extends Expr {
        public Expr expr, expr2, exprDefault;

        public ArrayDefault(Expr expr, Expr expr2, Expr exprDefault, Location loc) {
            super(ARRAYDEFAULT, loc);
            this.expr = expr;
            this.expr2 = expr2;
            this.exprDefault = exprDefault;
        }
    ...
    public static class ArrayComp extends Expr {
        public Expr expr, expr2, ifExpr;
        public String ident;
        public boolean boolConst;

        public ArrayComp(Expr expr, String ident, Expr expr2, Expr ifExpr, Location loc) {
            super(ARRAYCOMP, loc);
            this.expr = expr;
            this.expr2 = expr2;
            this.ifExpr = ifExpr;
        ...
        public ArrayComp(Expr expr, String ident, Expr expr2, Location loc) {
            super(ARRAYCOMP, loc);
            this.expr = expr;
            this.expr2 = expr2;
            this.ifExpr = null;
    ...
    public static class ForeachStmt extends Tree {
        ...
        public String ident;
        public TypeLiteral type;
        public boolean boolConst, isType;

        //        Tree.ForeachStmt($3.ident, $3.type, $5.expr, $6.expr, $8.stmt);
        public ForeachStmt(String ident, TypeLiteral type, Expr expr, Expr expr2, Tree stmt, Location loc) {
